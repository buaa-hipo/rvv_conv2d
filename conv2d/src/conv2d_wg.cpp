...
double conv2d(DATA_TYPE *input, int in_c, int in_h, int in_w, DATA_TYPE *kernel,
  ...
  printf("***** start vector/im2col/winograd version *****\n");
  ...
  // stride = 1
  // k_h * k_w = 3 * 3
  // printf("start winograd\n");
  conv2d_winograd(out_c, in_c, pad_h, pad_w, kernel, pad_in, output);
...
int main(int argc, char **argv) {
  ...
  printf("vector/im2col/winograd time: %lf\n", cost_time_v);
  // #endif
